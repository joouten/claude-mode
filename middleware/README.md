...
- **Event-driven, not polled.** The watchdog `Observer` fires immediately on `CODE_TO_CHAT.md` create/modify events. A 1-second debounce coalesces the create-then-modify pair most editors emit.
